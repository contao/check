...
return array(
	...
	'You cannot install Contao 2.x (requires PHP %s+)' => 'Вы не можете установить Contao 2.x (требуется PHP %s+)',
	'You can install Contao 3.x' => 'Вы можете установить Contao 3.x',
	'You cannot install Contao 3.x (requires PHP %s+)' => 'Вы не можете установить Contao 3.x (требуется PHP %s+)',
	'You can install Contao 4.x' => 'Вы можете установить Contao 4.x',
	'You cannot install Contao 4.x (requires PHP %s+)' => 'Вы не можете установить Contao 4.x (требуется PHP %s+)',
	...
	'It seems that FastCGI in combination with the eAccelerator extension is buggy when it comes to Phar archives. You can either disable the eAccelerator extension or use a different PHP cache instead (e.g. FastCGI+APC).' => 'Вероятно FastCGI, в сочетании с расширением eAccelerator, работает нестабильно когда дело доходит до Phar архивов. Можно отключить расширение eAccelerator или вместо этого использовать различные кэшы PHP (напр. FastCGI + APC).',
	...
	'Maybe the request has been blocked by a firewall. Please contact your server administrator.' => 'Возможно, запрос заблокирован брандмауэром. Обратитесь к администратору сервера.',
