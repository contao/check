...
return array(
	...
	'You cannot install Contao 2.x (requires PHP %s+)' => 'Sie können Contao 2.x nicht installieren (benötigt PHP %s+)',
	'You can install Contao 3.x' => 'Sie können Contao 3.x installieren',
	'You cannot install Contao 3.x (requires PHP %s+)' => 'Sie können Contao 3.x nicht installieren (benötigt PHP %s+)',
	'You can install Contao 4.x' => 'Sie können Contao 4.x installieren',
	'You cannot install Contao 4.x (requires PHP %s+)' => 'Sie können Contao 4.x nicht installieren (benötigt PHP %s+)',
	...
	'Maybe the request has been blocked by a firewall. Please contact your server administrator.' => 'Eventuell wurde die Anfrage von einer Firewall blockiert. Bitte kontaktieren Sie Ihren Serveradministrator.',
